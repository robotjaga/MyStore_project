...
if(isset($_POST['insert_product'])) {
    // Retrieve form inputs with security
    ...
    // Check if category and brand exist in database
    ...
    if (!validate_image($product_image1) || !validate_image($product_image2) || !validate_image($product_image3)) {
